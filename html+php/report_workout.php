...
?>
<?php
$all="select w.mem_id,w.bmi, w.age, f.push_up,f.pull_up from workout_plan w join fitness_checklist f on w.mem_id=f.mem_id";
echo "<table border='1'>
<tr>
<th>Member ID</th>
<th>BMI</th>
...
echo "<td>".$row['BMI']."</td>";
echo "<td>".$row['AGE']."</td>";
echo "<td>".$row['PUSH_UP']."</td>";
echo "<td>".$row['PULL_UP']."</td>";
}
?>
</body>
</html>